...
- [`playwright-policy/no-data-attribute-selector`](docs/no-data-attribute-selector.md)
- [`playwright-policy/no-id-selector`](docs/no-id-selector.md)
- [`playwright-policy/no-name-attribute-selector`](docs/no-name-attribute-selector.md)
